...
//	private final String lib = new File(classPathUrl).getParent() + "\\lib\\";
    ...
    private static final List<String> includeJars = new ArrayList<String>();
    private static final List<Class<? extends Model>> excludeClasses = new ArrayList<Class<? extends Model>>();
